...
- Includes:
  - **Dynamic pricing (retail, DP + constraints)** — *Centric Pricing RL*. 
  - **Predictive pricing (real-estate packs, MNL)** — *Pricing Model Case Study*.
  - **Uplift modeling (premium upsell, Qini/AUUC)** — *Leboncoin – Cars*.
  - **Two-tower retrieval ranking (TFRS, Recall@10, debiasing)** — *Ranking model explained*.
