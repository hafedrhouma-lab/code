...
class TrainingParams(BaseSettings):
    train_date_start: str = Field(default="2024-06-01")
    train_date_end: str = Field(default="2024-12-01")
    test_date_start: str = Field(default="2024-12-02")
    test_date_end: str = Field(default="2024-12-08")
