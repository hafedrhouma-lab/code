...
INCLUDED_VENDOR_GRADES = ['A', 'B', 'C', 'D']
...
if __name__ == "__main__":
    ...
    DST_TABLE_NAME = f"data_feature_store.chain_embeddings_for_two_tower_coldstart_abcd_v3_mlf_all"
    DATASET_ID = "data_feature_store"
    TABLE_NAME = "chain_embeddings_for_two_tower_coldstart_abcd_v3_mlf_all"
